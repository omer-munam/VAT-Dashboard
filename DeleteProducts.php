    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="AddShop.php" aria-expanded="true"><i class="fa fa-circle fs_i"></i><span class="menu-title">Add Shop</span></a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Delete Products</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Delete Contents / </span></li>
                                <li><span>Delete Products</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">All Products</h4><br><br>
                 <table id="table1" class="table table-striped table-hover" style="width: 90%;margin-left: 60px;height: 180px">
                       ...
                       <?php
                        $query = "SELECT * FROM products WHERE admin_approved=1";
        ...
        <table id="table1" class="table table-striped table-hover" style="width: 90%;margin-left: 60px;height: 180px">
            <thead style="background:#afcad3;font-weight: bolder;">
                        ...
                        <tr style="background-color: #ffffff">
                         ...
                         <tr style="background-color: #ffffff">
                           <td>Store ID</td>
                          <td><?php echo $from_storeid;  ?> </td>
                        </tr>

                        <tr style="background-color: #ffffff">
                           <td>Location ID</td>
                          <td><?php echo $from_locid;  ?> </td>
                        </tr>
