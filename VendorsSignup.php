    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="VendorsSignup.php"><i class="fa fa-circle fs_i"></i>Vendors Signup</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="CustomersSignup.php"><i class="fa fa-circle fs_i"></i>Customers Signup</a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Vendor Signup</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Vendors / </span></li>
                                <li><span>Vendor Signup</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">Vendors Signup</h4><br><br>
