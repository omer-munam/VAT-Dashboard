<?php
  ...
  if (!isset($_SESSION['loggedin'])  && $_SESSION['loggedin'] !== 1) {
    ...
    if (isset($_POST['add'])) {
        ...
        $query = "INSERT INTO categories(title_ar,title_en,images,status,is_admin) VALUES('$title_ar','$title_en','$filename','$status','$venid')";
        
        $query123 = "SELECT * FROM categories WHERE (title_ar='$title_ar' OR title_en='$title_en')";
        ...
        if ($row_count<1) {
            ...
            $.bootstrapGrowl('The Category Has Been Added Successfully', {
                type: 'success',
                align: 'right',
                width: 400,
                stackup_spacing: 30
            ...
            echo "<script>setTimeout(function() {
            $.bootstrapGrowl('Category Name Exists', {
                type: 'info',
                align: 'right',
                width: 400,
                stackup_spacing: 30
...
<body>
    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="AddCategories.php" aria-expanded="true"><i class="fa fa-circle fs_i"></i><span class="menu-title">Add Categories</span></a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">All Categories</h4>
        ...
        <div id="product_name_div">
            ...
            <div class="col-xs-6">
                  <input type="file" required class="form-control" name="Images" required>
                <div id="product_name_error"></div>
              </div>
            </div>          
          </div>
