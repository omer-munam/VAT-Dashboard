<?php
    ...
    if (!isset($_SESSION['isvendor']) && $_SESSION['isvendor'] !== 1 && $_SESSION['loggedin'] !== 1) {
            ...
            $query = "SELECT phonenumber FROM stores where id='$id' limit 1";
        ...
        if (isset ($_POST['newphone'])){
            ...
            $query1="Select password from stores where id =$id limit 1";
            ...
            if(mysqli_num_rows($result)>0){
                ...
                if($password1===$password){
                    $query1="UPDATE stores SET phonenumber='$phone_number' where id=$id ";
                    mysqli_query($conn,$query1);
                   
                    echo "<script>setTimeout(function() {
      $.bootstrapGrowl('Phone Number Updated', {
          type: 'success',
          align: 'right',
          width: 400,
          stackup_spacing: 30
                    ...
                    echo "<script>setTimeout(function() {
      $.bootstrapGrowl('Update failed Enter Correct Password', {
          type: 'danger',
          align: 'right',
          width: 400,
          stackup_spacing: 30
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Manage Phones</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Profile Settings / </span></li>
                                <li><span>Manage Phones</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form  method="POST" class="form-horizontal"  enctype="multipart/form-data"  style="padding-left: 100px; width: 400px">
    
       <div class="form-group">
        
        <div id="product_name_div">
            <label class="col-xs-6">Primary Phone<span class="validatestar">*</span></label>
            <div class="col-xs-6">
          ...
          <div class="form-group">
        <div id="product_name_div">
            <label class="col-xs-6">Enter Password to Update Phone Number<span class="validatestar">*</span></label>
            <div class="col-xs-6">
          ...
          <div style="text-align: left;">
              <button type="submit" class="btn btn-secondary btn-xs" name="newphone">Save Changes</button>
