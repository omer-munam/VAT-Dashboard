  ...
  if (!isset($_SESSION['isadmin']) && $_SESSION['isadmin'] !== 1 && $_SESSION['loggedin'] !== 1) {
     ...
     if (isset($_GET["del"]))
   {
     $id = $_GET['del'];
      ...
      $query_delete ="DELETE product,files,product_detail FROM product
      JOIN files on product.id=files.id
      JOIN product_detail on files.id=product_detail.id 
      WHERE product.id=$id AND files.id=$id AND product_detail.id=$id";
...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Delete All Products</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Products /</span></li>
                                <li><span>Delete Contents /</span></li>
                                <li><span>Delete All Products</span></li>
                            </ul>
                        </div>
                    </div>
  ...
  <tbody>
    <?php
       $query = "SELECT product.id,files.upload_file_img,product.product_name,product.brandId,product.categoryid,product_detail.price FROM product 
           JOIN files on product.id=files.id
           JOIN product_detail on files.id=product_detail.id ";
        ...
        if ($result->num_rows>0) {
           ...
           <tr>
            ...
            <td><img src=<?php echo $row["upload_file_img"] ?> style="height:50px;width:50px" /></td>
            <td><?php echo  $row["product_name"]?></td>
            <td><?php echo  $row["brandId"]?></td>
            <td><?php echo  $row["categoryid"]?></td>
            <td><?php echo  $row["price"]?></td>
            <td>  <a href="Delete-All-Products.php?del=<?php echo  $row["id"]?>" class="btn btn-xs btn-danger" >Delete</a></td>
