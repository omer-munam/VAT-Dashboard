    ...
    <div class="page-container">
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Delete Shops</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Delete Contents / </span></li>
                                <li><span>Delete Shops</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">All Shops</h4><br><br>
                 <table id="table1" class="table table-striped table-hover" style="width: 90%;margin-left: 60px;height: 180px">
                                        <thead style="background:#e8e8e8;font-weight: bolder;">
                                         <tr>
                           <th width="100px"> Shop Id</th>
                           <th> Shop Name In Arabic </th>
                           <th> Shop Name In English </th>
                           <th> Logo </th>
                           <th> Details </th>
                       ...
                       <?php
                        $query = "SELECT * FROM stores WHERE admin_approved=1";
                        ...
                        $row_cnt = $result->num_rows;
                         ...
                         <tr>
                           ...
                           <td style="background-color: #ffffff"><img src="<?php echo $row["images"] ?>" data-echo="<?php echo $row["images"] ?>" style="height:20px;width:20px" /></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="table1" class="table table-striped table-hover" style="width: 90%;margin-left: 60px;height: 180px">
            <thead style="background:#afcad3;font-weight: bolder;">
                        ...
                        <tr style="background-color: #ffffff">
                           <td>Store Title In Arabic</td>
                          <td><?php echo $title_ar;  ?> </td>
                        </tr>

                        <tr style="background-color: #ffffff">
                           <td>Store Title In English</td>
                          <td><?php echo $title_en;  ?> </td>
                        </tr>

                        <tr style="background-color: #ffffff">
                           <td>Image</td>
                          <td><img src="<?php echo $row["upload_file_img"] ?>" data-echo="<?php echo $row["upload_file_img"] ?>" style="height:50px;width:50px" /></td>
                        </tr>
                        ...
                        <tr style="background-color: #ffffff">
                          ...
                          <td><?php echo $store_cat;  ?> </td>
                        </tr>

                        <tr style="background-color: #ffffff">
                           <td>Reset Password</td>
                          <td><?php echo $reset_pwd;  ?> </td>
                        </tr>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            ...
                            <td style="background-color: #ffffff"><input type="submit"  name="actionbtndecline" class="actionbtn" value="Delete"></td>
                           </tr>
