    ...
    <div class="page-container">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="AllVendor.php"><i class="fa fa-circle fs_i"></i>All Vendor</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">All Vendor</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Delievery Management / </span></li>
                                <li><span>All Vendor</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">All Vendors</h4><br><br>
