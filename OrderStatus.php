    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="ManagePhones.php"><i class="fa fa-circle fs_i"></i>Manage Phones</a></li> 
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Order Status</h4>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">Order Status</h4><br><br>
                 <table id="table1" class="table table-striped table-hover" style="width: 90%;margin-left: 60px;height: 180px">
                                        <thead style="background:#e8e8e8;font-weight: bolder;">
                                         <tr>
                           <th width="100px" style="text-align: center"> Order Id</th>
                           <th width="100px" style="text-align: center"> Product Id</th>
                           <th width="100px" style="text-align: center"> Quantity</th>
                           <th width="100px"> User Id</th>
                           <th style="text-align: center"> Dated </th>
                           <th style="text-align: center"> Status </th>
                           <th width="100px" style="text-align: center"> Store Id</th>
                           <th style="text-align: center"> Thread Id </th>

                       </tr>
                                   </thead>

                                   <tbody style="background: #e8e8e8">
                       <?php
                        ...
                        $row_cnt = $result->num_rows;
                            ...
                            ?>
                         <tr>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $id ?></td>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $pid ?></td>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $qty ?></td>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $uid ?></td>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $dated ?></td>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $status ?></td>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $storeid ?></td>
                           <td style="background-color: #ffffff; text-align: center"><?php echo  $threadid ?></td>
                           <!-- 
