    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="ImageSetting.php"><i class="fa fa-circle fs_i"></i>Image Setting</a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Image Setting</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Admin Panel / </span></li>
                                <li><span>Image Setting</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">Image Setting</h4><br><br>
