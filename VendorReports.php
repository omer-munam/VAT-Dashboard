    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="VendorReports.php"><i class="fa fa-circle fs_i"></i>Vendor Reports</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Vendor Reports</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Reports / </span></li>
                                <li><span>Vendor Reports</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">Vendor Reports</h4><br><br>
