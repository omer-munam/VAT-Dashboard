    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="#" aria-expanded="true"><i class="fa fa-user-plus"></i> <span>Vendors</span></a>
                                <ul class="collapse">
                                    <li><a href="AllVendors.php"><i class="fa fa-circle fs_i"></i>All Vendors</a></li>
                                    <li><a href="AddVendors.php"><i class="fa fa-circle fs_i"></i>Add Vendors</a></li>
                                    <li><a href="VendorsSignup.php"><i class="fa fa-circle fs_i"></i>Vendors Signup</a></li>
                                    <li><a href="DeleteVendors.php"><i class="fa fa-circle fs_i"></i>Delete Vendors</a></li>
                                </ul>
                            </li>
                            <li class="active">
                                <a href="#" aria-expanded="true"><i class="fa fa-users"></i><span>Customers</span></a>
                                <ul class="collapse">
                                    <li><a href="AllCustomers.php"><i class="fa fa-circle fs_i"></i>All Customers</a></li>
                                    <li><a href="AddCustomers.php"><i class="fa fa-circle fs_i"></i>Add Customers</a></li>
                                    <li class="active"><a href="CustomersSignup.php"><i class="fa fa-circle fs_i"></i>Customers Signup</a></li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="AddVendor.php"><i class="fa fa-circle fs_i"></i>Add Vendor</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="Logout.php"><i class="fa fa-circle fs_i"></i>Logout</a></li>
                            ...
                            <li>
                                <a href="#" aria-expanded="true"><i class="fa fa-users"></i><span>Store Owner</span></a>
                                <ul class="collapse">
                                    <li><a href="SetCommission.php"><i class="fa fa-circle fs_i"></i>Set Commission</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" aria-expanded="true"><i class="fa fa-flag"></i><span>Countries & City Management</span></a>
                                <ul class="collapse">
                                    <li><a href="AddCity.php"><i class="fa fa-circle fs_i"></i>Add City</a></li>
                                    <li><a href="AddCountries"><i class="fa fa-circle fs_i"></i>Add Countries</a></li>
                                    <li><a href="AllCities.php"><i class="fa fa-circle fs_i"></i>All Cities</a></li>
                                    <li><a href="AllCountries.php"><i class="fa fa-circle fs_i"></i>All Countries</a></li>
                                    <li><a href="DeleteCities.php"><i class="fa fa-circle fs_i"></i>Delete Cities</a></li>
                                    <li><a href="DeleteCountries.php"><i class="fa fa-circle fs_i"></i>Delete Countries</a></li>
                                    <li><a href="BlockCities.php"><i class="fa fa-circle fs_i"></i>Block Cities</a></li>
                                    <li><a href="BlockCountries.php"><i class="fa fa-circle fs_i"></i>Block Countries</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" aria-expanded="true"><i class="fa fa-question"></i><span>FAQ</span></a>
                                <ul class="collapse">
                                    <li><a href="AddFAQ.php"><i class="fa fa-circle fs_i"></i>Add FAQ</a></li>
                                    <li><a href="ManageFAQ.php"><i class="fa fa-circle fs_i"></i>Manage FAQ</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#" aria-expanded="true"><i class="fa fa-tasks"></i><span>Roles</span></a>
                                <ul class="collapse">
                                    <li><a href="AddRoles.php"><i class="fa fa-circle fs_i"></i>Add Roles</a></li>
                                    <li><a href="ManageRoles.php"><i class="fa fa-circle fs_i"></i>Manage Roles</a></li>
                                    <li><a href="AllRoles.php"><i class="fa fa-circle fs_i"></i>All Roles</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="FilterOrder.php" aria-expanded="true"><i class="fa fa-first-order"></i> <span>Filter Order</span></a>
                            </li>
                            <li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Customers Signup</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Customers / </span></li>
                                <li><span>Customers Signup</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="index.php" method="POST">
                <h4 class="container">Customer Signup</h4><br><br>
