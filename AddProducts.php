<?php
    ...
    include("includes/connection.php");
        ...
        // $extension1 = explode(".", $_FILES["Images"] ["name"]);
        // $filename = md5(time()). rand(1,9999) . '.' . end($extension1);
        //         move_uploaded_file($temp_name,$_SERVER['DOCUMENT_ROOT'] . "http://dalilalqahwa.com/app/images/products/$filename");
                
          $temp_name = $_FILES["Image"]["tmp_name"];
        $extension1 = explode(".", $_FILES["Image"] ["name"]);
        $filename = md5(time()). rand(1,9999) . '.' . end($extension1);
                move_uploaded_file($temp_name,"../app/images/products/$filename");
                    ...
                    $query = "INSERT INTO products(barcode,title_ar, title_en, images,default_price,catid, subcat, status, from_storeid) VALUES('$barcode', '$title_ar', '$title_en','$filename','$default_price','$catid','$subcat','$status','$from_storeid')";

                   
                    if($conn->query($query)===TRUE){
                      echo "<script>setTimeout(function() {
        $.bootstrapGrowl('The Product Has Been Added Successfully', {
            type: 'success',
            align: 'right',
            width: 400,
            stackup_spacing: 30
...
<body>
    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="AddProducts.php" aria-expanded="true"><i class="fa fa-circle fs_i"></i><span class="menu-title">Add Products</span></a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add Products</h4>
            ...
            <form action="AddProducts.php" method="POST" class="form-horizontal"  enctype="multipart/form-data" onsubmit="return Validate()" name="bform" id="uploadForm" style="padding-left: 100px; width: 400px">
       ...
       <!--   </div>-->
        ...
        <div id="product_name_div">
            ...
            <div class="col-xs-6">
                  <input type="text" required class="form-control" name="default_price" >
                <div id="product_name_error"></div>
              </div>
            </div>          
          </div>
        ...
        <div id="product_name_div">
            ...
            ?>
                ...
                <select name="catid" required class="form-control" id="catid" style="height: 50px">
                    <?php 
          ...
          <div style="text-align: center;">
              <button type="submit" class="btn btn-secondary btn-md" name="pubish123">Add</button>
