<?php
    ...
    if(isset($_POST["actionbtndecline"]))
    {
        ...
        $query = "DELETE FROM categories WHERE id='$s_id'";
   ...
   if (isset($_POST['edit'])) {
        ...
        if($file_tmp!='')
        {
            ...
            move_uploaded_file($file_tmp,$file_path);
             ...
             $query = "UPDATE categories SET title_ar='$title_ar', title_en='$title_en', Images='$filename', status='$status' WHERE id='$id'";
        }

        else
        {
             $query = "UPDATE categories SET title_ar='$title_ar', title_en='$title_en', status='$status' WHERE id='$id'";
                  ...
                  <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <!-- <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="AllCategories.php" aria-expanded="true"><i class="fa fa-circle fs_i"></i><span class="menu-title">All Categories</span></a></li>
     ...
     <div class="container">
       ...
       <tbody>
           <?php
                            mysqli_set_charset($conn,'utf8');
                            $stid =$_SESSION['id'];
                            $query = "SELECT * FROM categories WHERE id IN (SELECT catid FROM cat_stores WHERE storeid='$stid') AND admin_approved='1'";
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <form action="AllCategories.php" method="POST" class="form-horizontal"  enctype="multipart/form-data" onsubmit="return Validate()" name="bform" id="uploadForm" >
