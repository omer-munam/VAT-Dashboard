...
include("includes/connection.php");
  ...
  if (!isset($_SESSION['isadmin']) && $_SESSION['isadmin'] !== 1 && $_SESSION['loggedin'] !== 1) {
      ...
      if (isset($_GET["del"])) {
          ...
          $query ="DELETE FROM og_brand WHERE id=$id";
          if ($conn->query($query)===TRUE)
           {
              
              // echo "<script>alert('Brand Deleted successfully')</script>";
              header("location:Delete-All-Brands.php");
                                ...
                                <ul class="collapse">
                                    <li><a href="#" aria-expanded="true"><i class="fa fa-list"></i><span class="menu-title">Physical Products</span></a>
                                        <ul class="collapse">
                                            ...
                                            <li><a href="Brands.html"><i class="fa fa-circle fs_i"></i>Brands</a></li>
                                            <li><a href="Sub-category.html"><i class="fa fa-circle fs_i"></i>Sub-category</a></li>
                                            <li><a href="All-Products.html"><i class="fa fa-circle fs_i"></i>All Products</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Delete All Brands</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Products /</span></li>
                                <li><span>Delete Contents /</span></li>
                                <li><span>Delete All Brands</span></li>
                            </ul>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                         ...
                         $query_brand = "SELECT * FROM og_brand";
                         $result = mysqli_query($conn,$query_brand);
                         if ($result->num_rows>0) {
                             while ($row=$result->fetch_assoc()) {?>
                                <tr>
                                    <td><?php echo $row["id"] ?></td>
                                    <td><?php echo $row["brand_name"] ?></td>
                                    <td> <a href="Delete-All-Brands.php?del=<?php echo  $row["id"]?>" class="btn btn-xs btn-danger">Delete</a></td>
