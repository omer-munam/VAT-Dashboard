<?php
  ...
  if (!isset($_SESSION['loggedin'])  && $_SESSION['loggedin'] !== 1) {
    ...
    if (isset($_POST['add'])) {
        ...
        move_uploaded_file($temp_name,"../app/images/categories/$filename");
        ...
        $query = "INSERT INTO subcat(title_ar,title_en,images,catid,status,admin_approved) VALUES('$title_ar','$title_en','$filename','$catid','$status',1)";
        $query123 = "SELECT * FROM subcat WHERE (title_ar='$title_ar' OR title_en='$title_en')";
        ...
        if ($row_count<1) {
            ...
            $.bootstrapGrowl('The SubCategory Has Been Added Successfully', {
                type: 'success',
                align: 'right',
                width: 400,
                stackup_spacing: 30
            ...
            echo "<script>setTimeout(function() {
            $.bootstrapGrowl('Subcategory With Same Name Exists', {
                type: 'info',
                align: 'right',
                width: 400,
                stackup_spacing: 30
...
<body>
    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="AddSubCategories.php" aria-expanded="true"><i class="fa fa-circle fs_i"></i><span class="menu-title">Add Subcategories</span></a></li>
                                </ul>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add Subcategories</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Category/ </span></li>
                                <li><span>Add Subcategories</span></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div id="product_name_div">
            ...
            <div class="col-xs-6">
                  <input type="text" required class="form-control" name="title_ar" required>
        ...
        <div id="product_name_div">
            ...
            <div class="col-xs-6">
                  <input type="text" required class="form-control" name="title_en" required>
                <div id="product_name_error"></div>
              </div>
            </div>          
          </div>
        ...
        <div id="product_name_div">
            ...
            ?>
                ...
                <select name="catid" required class="form-control" id="Category" style="height: 40px">
                    <?php 
          ...
          <div style="text-align: center;">
              <button type="submit" class="btn btn-secondary btn-md" name="add">Add</button>
